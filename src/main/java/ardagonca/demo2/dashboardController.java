...
public class dashboardController implements Initializable {
    ...
    public void addEmployeeUpdate() {
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                alert.setHeaderText(null);
                alert.setContentText("Lütfen tüm bosluklari doldurunuz.");
                alert.showAndWait();
            } else {
                alert = new Alert(AlertType.CONFIRMATION);
                alert.setTitle("Dogrulama Mesajı");
                alert.setHeaderText(null);
                alert.setContentText("Düzenlemek istedigine emin misin? Employee ID: " + addEmployee_employeeID.getText() + "?");
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    alert.setHeaderText(null);
                    alert.setContentText("Basariyla düzenlendi.");
                    alert.showAndWait();
    ...
    public void addEmployeeDelete() {
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                ...
                alert.setHeaderText(null);
                alert.setContentText("Lutfen tüm bosluklari doldurunuz.");
                alert.showAndWait();
            } else {
                alert = new Alert(AlertType.CONFIRMATION);
                alert.setTitle("Dogrulama Mesajı");
                alert.setHeaderText(null);
                alert.setContentText("Silmek istedigine emin misin? Personel ID: " + addEmployee_employeeID.getText() + "?");
                Optional<ButtonType> option = alert.showAndWait();
                ...
                if (option.get().equals(ButtonType.OK)) {
                    ...
                    alert.setHeaderText(null);
                    alert.setContentText("Başariyla silindi.");
                    alert.showAndWait();
    ...
    public void addEmployeeInsertImage() {
        ...
        if (file != null) {
            ...
            image = new Image(file.toURI().toString(), 129, 126, false, true);
            addEmployee_image.setImage(image);
        }
    }

    private String[] positionList = {"Content Creator", "Back End Developer", "Front End Developer", "App Developer","Marketer Coordinator","UI Designer"};
    ...
    private String[] listGender = {"Erkek", "Kadin", "Diger"};
    ...
    public void addEmployeeSelect() {
        ...
        image = new Image(uri, 129, 126, false, true);
        addEmployee_image.setImage(image);
    }
    ...
    public void defaultNav () {
        home_btn.setStyle("-fx-background-color: #381878");
    }
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == home_btn) {
            ...
            home_btn.setStyle("-fx-background-color: #381878");
            addEmployee_btn.setStyle("-fx-background-color: #36119f");
            salary_btn.setStyle("-fx-background-color: #36119f");
            ...
            addEmployee_btn.setStyle("-fx-background-color: #381878");
            salary_btn.setStyle("-fx-background-color: #36119f");
            home_btn.setStyle("-fx-background-color: #36119f");
            ...
            salary_btn.setStyle("-fx-background-color: #381878");
            addEmployee_btn.setStyle("-fx-background-color: #36119f");
            home_btn.setStyle("-fx-background-color: #36119f");
